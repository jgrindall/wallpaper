...
export const compose = (...matrices: Array<Matrix>):Matrix=>{
    return tmcompose(matrices.reverse());
};

export const composeAllWith = (matrices: Array<Matrix>, t:Matrix):Array<Matrix>=>{
...
export const conjugates = (a:Matrix, bs:Array<Matrix>):Array<Matrix>=>{
...
export const getTranslations = (dx:number, dy:number, min:number, max:number):Array<Matrix> => {
...
export const getProduct = (a1:Array<Matrix>, a2:Array<Matrix>):Array<Matrix> => {
    const p:Array<Matrix> = [];
    a1.forEach(t1=>{
        a2.forEach(t2=>{
