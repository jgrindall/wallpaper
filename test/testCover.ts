...
describe('test getTranslationsToCoverRect',() => {
    ...
    expect(areEqual(ts2[0], getTranslation(2, 2))).to.equal(true);
    expect(areEqual(ts2[8], getTranslation(6, 6))).to.equal(true);
...
describe('test getTranslationsToCoverPolygon',() => {
    ...
    expect(ts1.length).to.equal(9);
    expect(areEqual(ts1[0], getTranslation(1, 1))).to.equal(true);
